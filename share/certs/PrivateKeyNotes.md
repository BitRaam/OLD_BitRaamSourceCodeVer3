...
unlocked to sign the Bitraam-Qt.app bundle.
...
allowing somebody to distribute a Bitraam-Qt.app or bitraam-qt-setup.exe with a valid
...
that the bitraam-qt.exe file inside the installer had not been tampered with.
