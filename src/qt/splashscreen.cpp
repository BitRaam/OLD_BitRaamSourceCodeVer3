    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitraam Developers"));
    QString copyrightText2  = QChar(0xA9)+QString(" 2013 ") + QString(tr("The BitRaam Team"));
    QString testnetAddText  = QString(tr("[testnet]")); // define text to place as single text object

    QString font            = "DistrictTF-RegularItalic";
